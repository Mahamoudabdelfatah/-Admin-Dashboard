  ...
  return (
    <>
      <Drawer variant="permanent" open={open}>
        ...
        <Avatar sx={{ mx: "auto", width: open ? 88 : 44, height: open ? 88 : 44, my: 1, border: "2px solid gray", transition: "0.25s" }} alt="Mahmoud" src="Me.jpg" />
        <Typography align='center' sx={{ fontSize: open ? 17 : 0, transition: "0.25s" }}>Mahmoud</Typography>
